...
PHP_METHOD(BinlogClient, __construct);
PHP_METHOD(BinlogClient, __destruct);
PHP_METHOD(BinlogClient, connect);
PHP_METHOD(BinlogClient, setPosition);
PHP_METHOD(BinlogClient, waitForNextEvent);
